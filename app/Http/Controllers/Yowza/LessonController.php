...
{
    //
    public function show($course_id, $lesson_slug): \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('yowzacampus.lessons.index', compact('lesson', 'previous_lesson', 'next_lesson','purchased_course','test_exists','test_result'));
    }

    public function test($lesson_slug, Request $request): \Illuminate\Http\RedirectResponse
    {
