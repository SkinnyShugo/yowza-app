...
class QuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $questions = Question::onlyTrashed()->paginate(10); // Change 10 to the number of items per page you want
        } else {
            $questions = Question::paginate(10); // Change 10 to the number of items per page you want
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.questions.index', ['prefix' => 'admin']);
    }
