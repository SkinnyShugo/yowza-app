...
class QuestionOptionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $question_options = QuestionOption::onlyTrashed()->paginate(10); // Adjust the number of items per page as needed
        } else {
            $question_options = QuestionOption::paginate(10); // Adjust the number of items per page as needed
        }
