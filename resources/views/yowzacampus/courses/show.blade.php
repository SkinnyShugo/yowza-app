    ...
    <div class="col-span-12 pt-6 lg:col-span-8 lg:pb-6">
        <div class="card p-4 lg:p-6">
            ...
            <div class="mt-6 font-inter text-base text-slate-600 dark:text-navy-200">
                ...
                <img class="mt-5 h-80 w-full rounded-lg object-cover object-center" src="{{ Storage::url($course->course_image) }}" alt="image">
                <p class="mt-1 text-center text-xs+ text-slate-400 dark:text-navy-300">
                    <span> Course Category </span>
                    <a href="#" class="underline">Finance</a>
                </p>
                <br>
                <p>
        ...
        <div class="mt-5">
            ...
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-1 lg:gap-6">
                ...
                <div class="card lg:flex-row">
                    <img class="h-48 w-full shrink-0 rounded-t-lg bg-cover bg-center object-cover object-center lg:h-auto lg:w-48 lg:rounded-t-none lg:rounded-l-lg" src="{{ Storage::url($lesson->course->course_image) }}" alt="image">
                    <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="-mr-1.5 flex space-x-1">
                                ...
                                <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
                                    ...
                                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: auto 0px 0px auto; margin: 0px; transform: translate(-373px, 1476px);" data-popper-placement="top-end" data-popper-reference-hidden="" data-popper-escaped="">
                        ...
                        <div>
                            <a href="#" class="text-lg font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">{{ $lesson->title }}</a>
                        </div>
                        <p class="mt-1 line-clamp-3">
                            {{ strip_tags($lesson->short_text) }}
                        </p>

                        <div class="mt-1 flex justify-end">
                            <a href="{{ route('lessons.show', [$lesson->course_id, $lesson->slug]) }}" class="btn px-2.5 py-1.5 font-medium text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                                View Lesson
                            </a>
                        </div>
                    </div>
    ...
    <div class="col-span-12 py-6 lg:sticky lg:bottom-0 lg:col-span-4 lg:self-end">
            ...
            <div class="px-4 pt-2 pb-5 sm:px-5">
                ...
                <div class="mt-4">
                    <form action="{{ route('courses.payment') }}" method="POST">
                        ...
                        <button class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">Enroll</button>
                    </form>
                </div>
                @else
                <!-- Handle case where there are no published lessons -->
                <div class="mt-4">
                    <p>No published lessons available</p>
                </div>
                @endif
                @endif
                @else
                <div class="mt-4">
                    <a href="{{ route('register') }}?redirect_url={{ route('courses.show', [$course->slug]) }}" class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"> Register for this course</a>
                </div>
                @endif
        ...
        <div class="mt-5">
            <p class="border-b border-slate-200 pb-2 text-base text-slate-800 dark:border-navy-600 dark:text-navy-100">
                Related Courses(feature coming soon)
            </p>
            <div class="mt-3 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-1">
                ...
                <div class="flex justify-between space-x-2">
                    <div class="flex flex-1 flex-col justify-between">
                        <div>
                            <p class="text-xs font-medium line-clamp-1">{{$item->start_date}}</p>
                            <div class="mt-1 text-slate-800 line-clamp-3 dark:text-navy-100">
                                <a href="#" class="font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">{{ $item->title }}</a>
                            </div>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-xs font-medium line-clamp-1">Lessons Included</p>
                    ...
                    <img src="{{ Storage::url($item->course_image) }}" class="size-24 rounded-lg object-cover object-center" alt="image">
                </div>
                @endforeach
