...
@section('main_content')
    <div class="flex items-center justify-between py-5 lg:py-6">
        <div class="flex items-center space-x-1">
            ...
            <div x-data="usePopper({placement:'bottom-start',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
                ...
                <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px auto auto 0px; margin: 0px; transform: translate(280px, 122px);" data-popper-placement="bottom-start">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
        ...
        <div class="card">
            <div class="p-2.5">
                <img src="{{ Storage::url($course->course_image) }}" class="h-48 w-full rounded-lg object-cover object-center" alt="image">
            </div>
            <div class="flex grow flex-col px-4 pb-5 pt-1 text-center sm:px-5">
                <div><a class="text-xs+ text-info" href="#">Frameworks</a></div>
                <div class="mt-1">
                    <a href="#" class="text-lg font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">{{ $course->title }}</a>
                </div>
...
{{--                </p>--}}
                <div>
                    <a href="{{ route('course.show', [$course->slug]) }}" class="btn mt-4 rounded-full bg-primary font-medium text-white hover:bg-primary-focus hover:shadow-lg hover:shadow-primary/50 focus:bg-primary-focus focus:shadow-lg focus:shadow-primary/50 active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:hover:shadow-accent/50 dark:focus:bg-accent-focus dark:focus:shadow-accent/50 dark:active:bg-accent/90">
                        View Course
                    </a>
                </div>
            </div>
