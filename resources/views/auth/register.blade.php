...
<div class="w-full max-w-[26rem] p-4 sm:px-5">
    ...
    <div class="card mt-5 rounded-lg p-5 lg:p-7">
        <form method="POST" action="{{ route('register') }}">
            ...
            <label class="relative mt-4 flex">
                <input
                    ...
                    placeholder="Password" id="passowrd" type="password" name="password" autocomplete="new-password">
                <span
                    class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-colors duration-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
            ...
            <label class="relative mt-4 flex">
                <input
                    class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                    placeholder="Repeat Password" id="password-confirm" name="password_confirmation" type="password" autocomplete="new-password">
                <span
                    class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-colors duration-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
            ...
            <label for="gender" class="relative mt-4  flex">
                <div class="col-md-12">
                    <select id="gender"
            ...
            <label for="ethnics_group" class="relative mt-4 flex">
            ...
            <label class="relative mt-4  flex" for="nationality">
        ...
        <div class="my-7 flex items-center space-x-3">
            ...
            <p class="text-tiny+ uppercase"> signing up with social media coming soon</p>
            <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
        </div>
