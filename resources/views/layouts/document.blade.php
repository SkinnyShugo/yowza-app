<html lang="en" class="" style="--vh: 6.66px;">
...
<head>
    ...
    <title>yowza! | Document Library</title>
...
<body x-data="" x-bind="$store.global.documentBody" class="has-min-sidebar is-header-blur">
    <!-- App preloader-->
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900">
                    ...
                    <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                        <div class="is-scrollbar-hidden grow overflow-y-auto">
                            ...
                            <div class="mt-2 px-4">
                                ...
                                <a href="{{ route('admin.document-library.create', ['prefix' => 'admin']) }}"
                                ...
                                <div class="mt-4 flex items-center justify-between px-4">
                                    ...
                                    <div class="-mr-1.5 flex">
                                        ...
                                        <button @click="expanded =! expanded"
                                            class="btn size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5 rotate-180"
                                                ...
                                                <li x-data="{expanded:false}">
                                                    <div tabindex="0"
                                                        ...
                                                        <button @click="expanded = !expanded"
                                                            class="btn mr-1 size-5 rounded-lg p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="size-4.5 transition-transform rotate-90"
        ...
        <div x-show="$store.global.isRightSidebarExpanded"
            @keydown.window.escape="$store.global.isRightSidebarExpanded = false" style="display: none;">
                ...
                <div x-data="{activeTab:'tabHome'}"
                    ...
                    <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                        ...
                        <div class="mt-3">
                            ...
                            <div class="swiper mt-3 px-3 swiper-initialized swiper-horizontal"
                                ...
                                <div class="swiper-wrapper" style="transition-duration: 0ms; transition-delay: 0ms;"
                                    id="swiper-wrapper-575ef8ada4d7fe46" aria-live="polite">
                                    <div
                                ...
                                <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                    ...
                                    <div class="ax-transparent-gridline">
                                        <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.stockMarket1); $el._x_chart.render() });"
                                            ...
                                            <div id="apexchartsop8z2cebj" class="apexcharts-canvas apexchartsop8z2cebj"
                                                style="width: 0px; height: 100px;"><svg id="SvgjsSvg1060" width="0"
                                                    ...
                                                    <g id="SvgjsG1062" class="apexcharts-inner apexcharts-graphical">
                                ...
                                <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                    ...
                                    <div class="ax-transparent-gridline">
                                        <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.stockMarket2); $el._x_chart.render() });"
                                            style="min-height: 100px;">
                                            <div id="apexcharts49kkpkru" class="apexcharts-canvas apexcharts49kkpkru"
                                                style="width: 0px; height: 100px;"><svg id="SvgjsSvg1063" width="0"
                                                    height="100" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    xmlns:svgjs="http://svgjs.dev" class="apexcharts-svg"
                                                    xmlns:data="ApexChartsNS" transform="translate(0, 0)"
                                                    ...
                                                    <g id="SvgjsG1065" class="apexcharts-inner apexcharts-graphical">
                    ...
                    <div x-show="activeTab === 'tabProjects'"
                        ...
                        x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]"
                        x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                        class="is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1" style="display: none;">
                    ...
                    <div x-show="activeTab === 'tabActivity'"
                        ...
                        x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]"
                        x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                        class="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1" style="display: none;">
                ...
                <div class="flex w-full items-center justify-between">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                        ...
                        <div class="flex" x-data="usePopper({placement:'bottom-end',offset:12})"
                            ...
                            <div :class="isShowPopper &amp;&amp; 'show'" class="popper-root" x-ref="popperRoot"
                                style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-210px, 58px);"
                        ...
                        <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false"
                            ...
                            <div :class="isShowPopper &amp;&amp; 'show'" class="popper-root" x-ref="popperRoot"
                                style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-74px, 58px);"
                                data-popper-placement="bottom-end">
                                <div x-data="{activeTab:'tabAll'}"
        ...
        <div x-show="showDrawer" x-data="{showDrawer:false}"
            ...
            @keydown.window.escape="showDrawer = false" style="display: none;">
            ...
            <div class="fixed right-0 top-0 z-[101] h-full w-full sm:w-80">
                <div class="flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200 dark:bg-navy-700"
                    ...
                    <div x-init="$el._x_simplebar = new SimpleBar($el)"
                        class="flex grow flex-col overflow-y-auto overscroll-contain p-4"
                        x-data="{activeTab:'tab-recent'}" data-simplebar="init">
                                        ...
                                        <div class="simplebar-content" style="padding: 16px;">
                                            <div class="flex space-x-2">
                                                <button @click="activeTab = 'tab-recent'"
                                                    class="btn h-8 rounded-full text-xs+ font-medium bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                                                ...
                                                <button @click="activeTab = 'tab-activity'"
                                                    class="btn h-8 rounded-full text-xs+ font-medium hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 hover:text-slate-800 focus:text-slate-800 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                                    ...
                                                    <ol class="timeline line-space">
                                                        <li class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content flex-1 pl-4">
                                                                ...
                                                                <div class="mt-4 grid grid-cols-3 gap-2">
                                                                    <img src="images/object/object-3.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                    <img src="images/object/object-4.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                    <img src="images/object/object-5.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                </div>
                                                                <div class="mt-3 flex items-center space-x-2">
                                                                    ...
                                                                    <p class="text-xs+">
                                                                        ...
                                                                        <span
                                                                            class="text-slate-400 dark:text-navy-300">added
                                                                            3 new Photo</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <li class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content flex-1 pl-4">
                                                                ...
                                                                <div class="mt-4 grid grid-cols-3 gap-2">
                                                                    <img src="images/object/object-9.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                    <img src="images/object/object-8.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                    <img src="images/object/object-7.jpg"
                                                                        class="rounded-lg object-cover object-center"
                                                                        alt="image">
                                                                </div>
                                                                <div class="mt-3 flex items-center space-x-2">
    ...
    <div id="x-teleport-target">
        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" data-teleport-target="true"
            style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(136px, -12px);"
            data-popper-placement="right-end">
            <div
                class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                <ul>
...
<!-- Mirrored from lineone.piniastudio.com/apps-filemanager.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 14:30:48 GMT -->
